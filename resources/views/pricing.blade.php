        ...
        <<!-- Pricing -->
            <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                ...
                <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                    ...
                    <p class="mt-1 text-gray-600 dark:text-neutral-400">Whatever your status, our offers evolve according
                        to your needs.</p>
                </div>
                <!-- End Title -->
                ...
                <div class="mt-20 lg:mt-32">
                    ...
                    <div class="space-y-24 lg:hidden">
                        ...
                        <section>
                            <div class="px-4 mb-4">
                                <h2 class="text-lg leading-6 font-medium text-gray-800 dark:text-neutral-200">Startup
                                </h2>
                            </div>
                            <table class="w-full">
                                <caption
